...
export function calcGridItemPosition(
  ...
  // Otherwise, calculate from grid units.
    ...
    out.height = calcGridItemWHPx(h, rowHeight === 1 ? colWidth : rowHeight, margin[1]);
  }
  ...
  // Otherwise, calculate from grid units.
    ...
    out.top = Math.round(((rowHeight === 1 ? colWidth : rowHeight) + margin[1]) * y + containerPadding[1]);
...
export function calcWH(
  ...
  const h = Math.round((height + margin[1]) / ((rowHeight === 1 ? colWidth : rowHeight) + margin[1]));
