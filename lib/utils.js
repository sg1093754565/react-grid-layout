...
function resolveCompactionCollision(
  ...
  for (let i = itemIndex + 1; i < layout.length; i++) {
    ...
    if (collides(item, otherItem, step, 'strict')) {
...
export function compactItem(
  ...
  while (
    ...
    if (compactH) {
      resolveCompactionCollision(fullLayout, l, collides.x + collides.w, "x", step);
    } else {
      resolveCompactionCollision(fullLayout, l, collides.y + collides.h, "y", step);
    }
