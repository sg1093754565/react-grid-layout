...
export function getAllCollisions(
  ...
  return layout.filter(l => collides(l, layoutItem, compactType));
}
...
export function moveElement(
  ...
  const collisions = getAllCollisions(sorted, l, compactType);
...
export function moveElementAwayFromCollision(
  ...
  if (isUserAction) {
    ...
    const firstCollision = getFirstCollision(layout, fakeItem, compactType, 'strict');
