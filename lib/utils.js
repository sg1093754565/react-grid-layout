...
export function collides(l1: LayoutItem, l2: LayoutItem, compactType?: CompactType): boolean {
  if (compactType === null || compactType === 'null') {
    if (l1.i === l2.i) return false; // same element
    if (l1.x + l1.w <= l2.x + 16) return false; // l1 is left of l2
    if (l1.x + 16 >= l2.x + l2.w) return false; // l1 is right of l2
    if (l1.y + l1.h / 2 <= l2.y) return false; // l1 is above l2
    if (l1.y >= l2.y + l2.h / 2) return false; // l1 is below l2
